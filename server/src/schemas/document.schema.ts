...
export interface IDocument extends Document {
  ...
  // Auto-classification fields (generated by ML analysis)
  autoClassification?: {
    category: string;                    // e.g., 'customer_feedback', 'product_requirements', 'support_issue'
    topics: string[];                   // e.g., ['billing', 'api', 'user_interface']
    sentiment: 'positive' | 'neutral' | 'negative';
    ...
    confidence: number;                 // How confident the AI is in its classification (0-1)
